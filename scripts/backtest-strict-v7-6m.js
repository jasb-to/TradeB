...
function evaluateStrictV7(daily, h4, h1, h15) {
  ...
  const has4HTrend = Math.abs(h4_ema20 - h4_ema50) > 0.01
...
async function runBacktest() {
  ...
  console.log(`Data Period: ${daily[0].time} to ${daily[daily.length - 1].time}`)
