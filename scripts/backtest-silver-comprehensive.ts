...
const runBacktest = async (): Promise<BacktestResults> => {
  console.log("[v0] Starting COMPREHENSIVE SILVER STRATEGY Backtest for XAU_USD and XAG_USD...")
...
const runComprehensiveBacktest = async (): Promise<void> => {
  console.log("=".repeat(160))
  console.log("COMPREHENSIVE SILVER STRATEGY - TP1/TP2 ANALYSIS")
  console.log("=".repeat(160))
  
  const results = await runBacktest()
  
  console.log("\n" + "=".repeat(140))
  console.log("BACKTEST RESULTS WITH TP1/TP2 ANALYSIS")
  ...
  console.log("\n[v0] Comprehensive Silver strategy backtest complete!")
}
